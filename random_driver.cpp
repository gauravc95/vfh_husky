...
#define SAFE_SECTOR_CNT (60/ALPHA)
...
void maptomatrix(const sensor_msgs::LaserScan::ConstPtr& scan)  //to map value from polar to matrix
{
        ...
        //            //  double x=X*cos(theta)-Y*sin(theta)+bot_position_x;
        //            //  double y=X*sin(theta)+Y*cos(theta)+bot_position_y;  
        //            //  std::cout<<"i :"<<i<<" scan range : "<<scan->ranges[i]<<"\n";
        //            //  std::cout<<"Bot position x"<<bot_position_x<<" bot_position_y "<<bot_position_y<<"\n";
        //              // std::cout<<"new coordinate X"<<X<<"New Y coordinate "<<Y<<"\n";
        //              // std::cout<<"old coordinate X"<<x<<"old Y coordinate "<<y<<"\n";
        //              // std::cout<<"=================================================\n";
...
void processLaserScan(const sensor_msgs::LaserScan::ConstPtr& scan){
   ...
   //   ROS_INFO("Printing....%lu", scan->ranges.size());
      ...
      else if(theta_dest > 180){
        theta_dest = 360 - theta_dest;  
       // turn(-theta_dest - theta);
        std::cout<<"theta="<<-theta_dest<<" && "<<theta<<" => "<<(-theta_dest- theta)*180/PI <<"\n";
      }else{
       // turn(theta_dest - theta);
        std::cout<<"theta="<<theta_dest<<" && "<<theta<<" => "<<(theta_dest - theta)*180/PI<<"\n";
      }
...
void odomCallback(const nav_msgs :: Odometry::ConstPtr& odom){
 ...
 bot_position_x=findx(floor(x),floor(y));
  bot_position_y=findy(floor(x),floor(y));
